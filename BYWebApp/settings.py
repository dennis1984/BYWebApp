# -*- coding:utf8 -*-
"""
Django settings for BYWebApp project.
...
SECRET_KEY = '2Piefnk_l@*1-CIm8h&6i(w8)54!&0J)%ohd2n*p6kw2gs-m0*'
...
ROOT_URLCONF = 'BYWebApp.urls'

# # 跨域请求配置
CORS_ORIGIN_WHITELIST = (
    'yinglianke.city23.com',
)
...
WSGI_APPLICATION = 'BYWebApp.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'beiYing_Web',
        'USER': 'beiYing_project',
        'PASSWORD': 'Con!082%TribYIngX7^*',
        'HOST': '127.0.0.1',
        'PORT': 3306,
...
DATABASE_ROUTERS = ['BYWebApp.router.WebAppRouter']
